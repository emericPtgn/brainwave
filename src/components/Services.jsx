            ...
            <div className='relative'>
                ...
                >
                    ...
                    <div className='relative z-1 max-w-[17rem] ml-auto'>
                        ...
                        <p className='body-2 mb-[3rem] text-n-3'>Brainwave unlocks the potential of AI-powered application</p>
                        <ul className='body-2'>
                            ...
                            <ul className='flex items-center justify-between'>
                                {brainwaveServicesIcons.map((item, index) => (
                                    <li key={index} className={`flex items-center justify-center rounded-2xl
                                        ${index === 2 ? 
                                            'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'
                                        }
                                        `}>
